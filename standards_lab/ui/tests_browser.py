...
class BrowserTests(StaticLiveServerTestCase):
    ...
    def upload_data_file(self, project_name, file_name):
        # create new project
        self.get("/")
        self.create_new_project(project_name)
    ...
    def test_upload_data_file(self):
        ...
        data_upload = self.driver.find_element_by_id("form-control-file-data")
        data_upload.send_keys(
            os.path.join(os.path.dirname(__file__), "fixtures", "test_data.json")
        )
    ...
    def test_data_file_open_field(self):
        self.upload_data_file("new_project_foo", "test_data.json")
