...
class ProjectDownloadFile(View):
    def get(self, request, *args, **kwargs):
        ...
        if not kwargs["file_name"] in project.get("schemaFiles", []) + project.get("dataFiles", []):
            raise Http404
        ...
        try:
            ...
            return FAILED("Editing this file type in Standards Lab is not currently supported")
...
class ProjectUploadFile(View):
    def post(self, request, *args, **kwargs):
        ...
        file_destination = os.path.join(project["path"],
